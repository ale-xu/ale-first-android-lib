 ...
 */
public class HsuAddressSelectorAdapter extends BaseAdapter {

    private final Context context;
    private List<String> dataList = new ArrayList<>();
    private int selectedIndex = 0;

    public HsuAddressSelectorAdapter(Context context) {
        this.context = context;
    }

    public HsuAddressSelectorAdapter(Context context, List<String> dataList, int selectedIndex) {
        this.context = context;
